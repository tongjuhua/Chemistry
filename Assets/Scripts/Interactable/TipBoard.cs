namespace UCE
{
    ...
    public class TipBoard : MonoBehaviour
    {
        ...
        public static int sn, ssn;
        private static TipBoard tb;
        private static TextMesh textMesh, warningMesh, reactionMesh;
        private static string title, content;
        private static int cnt, greenmax, greenptr, fullmax, fullptr, warningLifetime;
        ...
        void Start()
        {
            ...
            reactionMesh = transform.Find("reaction").GetComponent<TextMesh>();
            sn = startStepNumber;
            UpdateText();
        }
